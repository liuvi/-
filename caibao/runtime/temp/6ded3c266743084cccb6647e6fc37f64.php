<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"E:\WWW\caibao\public/../application/admin\view\topic\edit.html";i:1535952458;s:55:"E:\WWW\caibao\application\admin\view\public\header.html";i:1535333950;s:55:"E:\WWW\caibao\application\admin\view\public\footer.html";i:1535333950;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form class="form-horizontal" method="post" id="signupForm" action="<?php echo url('Topic/edit'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <?php if(is_array($dataInfo['items']) || $dataInfo['items'] instanceof \think\Collection || $dataInfo['items'] instanceof \think\Paginator): $k = 0; $__LIST__ = $dataInfo['items'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                            <div class="row">
                                <div class="col-md-2">
                                    <label> 选项1 </label>
                                    <input type="text" name="items[<?php echo $k-1; ?>][value]" class="form-control" value="<?php echo $vo['value']; ?>">
                                </div>
                                <div class="col-md-3">
                                    <label>  答案 </label>
                                    <input type="text" name="items[<?php echo $k-1; ?>][title]" class="form-control" value="<?php echo $vo['title']; ?>">
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" name="value" class="form-control" value="<?php echo $dataInfo['value']; ?>" onkeyup="chekA(this)">
                        </div>
                    </div>
