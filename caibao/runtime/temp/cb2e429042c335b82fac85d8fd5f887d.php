<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\WWW\caibao\public/../application/admin\view\article\edit.html";i:1535635315;s:55:"E:\WWW\caibao\application\admin\view\public\header.html";i:1535333950;s:55:"E:\WWW\caibao\application\admin\view\public\footer.html";i:1535333950;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <div class="col-sm-12">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <form class="form-horizontal" method="post" id="signupForm" action="<?php echo url('Article/edit'); ?>">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">标题</label>
                        <div class="col-sm-10">
                            <input type="text" name="title" class="form-control" value="<?php echo $dataInfo['title']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <select class="form-control m-b" name="pid">
                                ...
                                <option value="<?php echo $vo['id']; ?>"  style="margin-left:55px;" <?php if($vo['id'] == $dataInfo['pid']): ?> selected <?php endif; ?>><?php echo $vo['name']; ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" style="">
                            <textarea name="content" style="width:100%;height: 200px;" id="editor"><?php echo $dataInfo['content']; ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            ...
                            <a href="<?php echo url('Article/index'); ?>" style="color: inherit;background: #fff;border: 1px solid #e7eaec;margin-bottom: 5px;border-radius: 3px;display: inline-block;padding: 6px 12px;font-size: 14px;font-weight: 400;line-height: 1.42857143;text-align: center;white-space: nowrap;vertical-align: middle;touch-action: manipulation;cursor: pointer;">取消</a>
                        </div>
                    </div>
